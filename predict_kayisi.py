...
# Eğitilmiş modeli yükleyin (en iyi model dosyasını kullanarak)
model = YOLO('runs/detect/train/weights/best.pt')  # Eğitilmiş modelin yolunu belirtin

# Test klasörünün yolunu ayarlayın
test_images_folder = "kayisi/test/images"  # Test resimlerinin bulunduğu klasör yolu
